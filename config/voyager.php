...
return [
    ...
    */
    ...
    'additional_css' => [
        'js/admin/tinymce/plugins/codesample/css/prism.min.css',
    ],

    'additional_js' => [
        'js/admin/tinymce/langs/ru.js',
        'js/admin/tinymce/plugins/codesample/plugin.js',
        'js/admin/tinymce/plugins/imagetools/plugin.js',
        'js/admin/tinymce/plugins/media/plugin.js',
        'js/admin/tinymce/plugins/template/plugin.js',
        'js/admin/tinymce/plugins/wordcount/plugin.js',
        'js/admin/custom.min.js?v=1.6',
    ],
