...
<div class="main-wrapper">
                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li class="active"><a href="blog.blade.php">BLOG</a>
                                        <ul class="sub-menu">
                                            <li><a href="blog.blade.php">Blog</a></li>
                                            <li class="active"><a href="single-blog.blade.php">Single Blog</a></li>
                                        </ul>
                                    </li>
    ...
    <div class="page-banner-section section" style="background-image: url(../../../public/images/blog/single-blog-page-title.jpg)">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 col-12 order-1 order-lg-2 mb-40">
                    <div class="single-blog">
                        <div class="image-wrap">
                            ...
                            <a class="image" href="single-blog.blade.php"><img src="../../../public/images/blog/single-blog.jpg" alt=""></a>
                        </div>
                        <div class="content">
                            <ul class="meta">
                        ...
                        <ul class="comment-list">
                            <li>
                                <div class="single-comment">
                                    <div class="image"><img src="../../../public/images/blog/author-1.jpg" alt=""></div>
                                    <div class="content">
                                        <h4>Frank Warren</h4>
                                ...
                                <ul class="child-comment">
                                    <li>
                                        <div class="single-comment">
                                            <div class="image"><img src="../../../public/images/blog/author-3.jpg" alt=""></div>
                                            <div class="content">
                                                <h4>Ronald Black</h4>
                                                <span>29/06/2018  &nbsp;&nbsp;-<a href="#">replay</a></span>
                                                <p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidi ut labore et dolo magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
                            ...
                            <li>
                                <div class="single-comment">
                                    <div class="image"><img src="../../../public/images/blog/author-2.jpg" alt=""></div>
                                    <div class="content">
                                        <h4>Beverly Cook</h4>
                                        <span>29/06/2018 &nbsp;&nbsp;-<a href="#">replay</a></span>
                                        <p>orem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidi ut labore et dolo magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.</p>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-blog-wrap">
                            <div class="sidebar-blog">
                                <a href="single-blog.blade.php" class="image"><img src="../../../public/images/blog/blog-1.jpg" alt=""></a>
                                <div class="content">
                                    <a href="single-product.blade.php" class="title">Lates and new Trens for baby fashion</a>
                                    <span class="date">25 may</span>
                                </div>
                            </div>
                            <div class="sidebar-blog">
                                <a href="single-blog.blade.php" class="image"><img src="../../../public/images/blog/blog-2.jpg" alt=""></a>
                                <div class="content">
                                    <a href="single-product.blade.php" class="title">New Collection New Trend all New Style</a>
                                    <span class="date">25 may</span>
                                </div>
                            </div>
                            <div class="sidebar-blog">
                                <a href="single-blog.blade.php" class="image"><img src="../../../public/images/blog/blog-3.jpg" alt=""></a>
                                <div class="content">
                                    <a href="single-product.blade.php" class="title">Lates and new Trens for baby fashion</a>
                                    <span class="date">25 may</span>
                                </div>
