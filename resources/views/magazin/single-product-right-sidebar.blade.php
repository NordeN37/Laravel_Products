...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="../../../Jadusona/jadusona/assets/css/bootstrap.min.css">

    <!-- Icon Font CSS -->
    <link rel="stylesheet" href="../../../public/css/icon-font.min.css">
    ...
    <!-- Modernizer JS -->
    <script src="../../../public/js/magazin_js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<div class="main-wrapper">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col mt-10 mb-10">
                        ...
                        <div class="header-top-right">
                            ...
                            <p><a href="login-register.blade.php">Register</a><a href="login-register.blade.php">Login</a></p>
                    ...
                    <div class="col mt-15 mb-15">
                        ...
                        <div class="header-logo">
                            <a href="index.blade.php">
                                <img src="../../../public/images/logo.png" alt="Jadusona">
                            </a>
                        </div><!-- Logo End -->
                    </div>
                    ...
                    <div class="col order-2 order-lg-3">
                        ...
                        <div class="header-shop-links">
                            ...
                            <div class="header-search">
                                <button class="search-toggle"><img src="../../../public/images/icons/search.png" alt="Search Toggle"><img class="toggle-close" src="../../../public/images/icons/close.png" alt="Search Toggle"></button>
                                <div class="header-search-wrap">
                                    <form action="#">
                                        <input type="text" placeholder="Type and hit enter">
                                        <button><img src="../../../public/images/icons/search.png" alt="Search"></button>
                                    </form>
                                </div>
                            </div>

                            <div class="header-wishlist">
                                <a href="wishlist.blade.php"><img src="../../../public/images/icons/wishlist.png" alt="Wishlist"> <span>02</span></a>
                            </div>

                            <div class="header-mini-cart">
                                <a href="cart.blade.php"><img src="../../../public/images/icons/cart.png" alt="Cart"> <span>02($250)</span></a>
                            </div>
                                ...
                                <ul>
                                    <li><a href="index.blade.php">HOME</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="index-box.blade.php">Home Box</a></li>
                                        </ul>
                                    </li>
                                    <li class="active"><a href="shop.blade.php">SHOP</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="single-product-left-sidebar.blade.php">Single Product Left Sidebar</a></li>
                                            <li class="active"><a href="single-product-right-sidebar.blade.php">Single Product Right Sidebar</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">PAGES</a>
                                        <ul class="sub-menu">
    ...
    <div class="page-banner-section section" style="background-image: url(../../../public/images/hero/hero-1.jpg)">
        <div class="container">
            <div class="row">
                <div class="page-banner-content col">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li><a href="single-product-right-sidebar.blade.php">Single Product Right Sidebar</a></li>
                    </ul>
                    ...
                    <div class="row row-20 mb-20 mb-xs-0">
                        ...
                        <div class="col-lg-6 col-12 mb-40">
                            ...
                            <div class="pro-large-img mb-10 fix easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                                <a href="../../../public/images/product/product-zoom-1.jpg">
                                    <img src="../../../public/images/product/product-big-1.jpg" alt=""/>
                                </a>
                            </div>
                            <!-- Single Product Thumbnail Slider -->
                            <ul id="pro-thumb-img" class="pro-thumb-img">
                                <li><a href="../../../public/images/product/product-zoom-1.jpg" data-standard="assets/images/product/product-big-1.jpg"><img src="../../../public/images/product/product-1.jpg" alt="" /></a></li>
                                <li><a href="../../../public/images/product/product-zoom-2.jpg" data-standard="assets/images/product/product-big-2.jpg"><img src="../../../public/images/product/product-2.jpg" alt="" /></a></li>
                                <li><a href="../../../public/images/product/product-zoom-3.jpg" data-standard="assets/images/product/product-big-3.jpg"><img src="../../../public/images/product/product-3.jpg" alt="" /></a></li>
                                <li><a href="../../../public/images/product/product-zoom-4.jpg" data-standard="assets/images/product/product-big-4.jpg"><img src="../../../public/images/product/product-4.jpg" alt="" /></a></li>
                                <li><a href="../../../public/images/product/product-zoom-5.jpg" data-standard="assets/images/product/product-big-5.jpg"><img src="../../../public/images/product/product-5.jpg" alt="" /></a></li>
                            </ul>
                        </div>
                            ...
                            <div class="col">
                                ...
                                <div class="product-item">
                                    <div class="product-inner">
                                        ...
                                        <div class="image">
                                            <img src="../../../public/images/product/product-1.jpg" alt="">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-product-wrap">
                            <div class="sidebar-product">
                                <a href="single-product.blade.php" class="image"><img src="../../../public/images/product/product-1.jpg" alt=""></a>
                                <div class="content">
                                    <a href="single-product.blade.php" class="title">Tmart Baby Dress</a>
                            ...
                            <div class="sidebar-product">
                                <a href="single-product.blade.php" class="image"><img src="../../../public/images/product/product-2.jpg" alt=""></a>
                                <div class="content">
                                    <a href="single-product.blade.php" class="title">Jumpsuit Outfits</a>
                            ...
                            <div class="sidebar-product">
                                <a href="single-product.blade.php" class="image"><img src="../../../public/images/product/product-3.jpg" alt=""></a>
                                <div class="content">
                                    <a href="single-product.blade.php" class="title">Smart Shirt</a>
...
<!-- jQuery JS -->
<script src="../../../public/js/magazin_js/vendor/jquery-1.12.4.min.js"></script>
<!-- Popper JS -->
<script src="../../../public/js/magazin_js/popper.min.js"></script>
<!-- Bootstrap JS -->
<script src="../../../public/js/magazin_js/bootstrap.min.js"></script>
<!-- Plugins JS -->
<script src="../../../public/js/plugins.js"></script>
<!-- Ajax Mail -->
<script src="../../../public/js/magazin_js/ajax-mail.js"></script>
<!-- Main JS -->
<script src="../../../public/js/magazin_js/main.js"></script>
