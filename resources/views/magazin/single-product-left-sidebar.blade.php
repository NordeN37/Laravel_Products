                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="shop.blade.php">SHOP</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="single-product-left-sidebar.blade.php">Single Product Left Sidebar</a></li>
            ...
            <div class="row">
                <div class="page-banner-content col">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li><a href="single-product.blade.php">Single Product Left Sidebar</a></li>
                    </ul>
