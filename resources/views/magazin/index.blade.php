...
<div class="main-wrapper">
    ...
    <div class="hero-section section">
        ...
        <div class="hero-slider hero-slider-one fix">
            ...
            <!-- Hero Item Start -->
            <div class="hero-item" style="background-image: url(../../../public/images/hero/hero-1.jpg)">
            ...
            <!-- Hero Item Start -->
            <div class="hero-item" style="background-image: url(../../../public/images/hero/hero-2.jpg)">
            ...
            <div class="row row-10">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    <div class="banner banner-1 content-left content-middle">
                        ...
                        <a href="#" class="image"><img src="../../../public/images/banner/banner-1.jpg" alt="Banner Image"></a>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    <a href="#" class="banner banner-2">
                        ...
                        <img src="../../../public/images/banner/banner-2.jpg" alt="Banner Image">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    <div class="banner banner-1 content-left content-top">
                        ...
                        <a href="#" class="image"><img src="../../../public/images/banner/banner-3.jpg" alt="Banner Image"></a>
        ...
        <div class="row row-5">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-10">
                <div class="banner banner-3">
                    ...
                    <a href="#" class="image"><img src="../../../public/images/banner/banner-4.jpg" alt="Banner Image"></a>

                    <div class="content" style="background-image: url(../../../public/images/banner/banner-3-shape.png)">
                        <h1>New Arrivals</h1>
                        <h2>Up to 35% off</h2>
                        <h4>2 - 5 Years</h4>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-10">
                <div class="banner banner-4">
                    ...
                    <a href="#" class="image"><img src="../../../public/images/banner/banner-5.jpg" alt="Banner Image"></a>
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-10">
                <div class="banner banner-5">
                    ...
                    <a href="#" class="image"><img src="../../../public/images/banner/banner-6.jpg" alt="Banner Image"></a>

                    <div class="content" style="background-image: url(../../../public/images/banner/banner-5-shape.png)">
